...
def end_environment(cur_task_indx, es_triggered=False):
    ...
    if args.trial_id is not None:
        ...
        seeds = [999, 998, 997] # Experiment Seeds
...
if __name__ == "__main__":
    ...
    for indx, cur_env in enumerate(sequence_keys):
        ...
        for iteration in range(1, args.num_iterations + 1):
            ...
            #     }
            #     rollout['states'] = initial_cfc_state if (args.cfc_actor or args.cfc_critic) else (initial_lstm_state if args.use_lstm else None)
